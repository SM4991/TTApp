...
public class TournamentRestController {
	...
	public ResponseEntity<Object> getTournaments(@RequestParam(defaultValue = "1") Integer page) {
	...
	public ResponseEntity<Object> createTournament(@Valid @RequestBody Tournament tournament, BindingResult errorResult) {
